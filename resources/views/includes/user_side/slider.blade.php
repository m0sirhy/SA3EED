<div class="tp-banner revolution">
    <ul>
        <li data-thumb="{{ asset('user_side/images/slides/01/slide-01.jpg') }}" data-transition="fade"
            data-slotamount="1" data-masterspeed="1000" data-saveperformance="off" data-title="Slide">
            <img src="{{ asset('user_side/images/slides/01/slide-01.jpg') }}" alt="slide1"
            ...
            <div class="tp-caption tp-caption1 lft stb"
                ...
                <div class="tp-caption1-wd-4"><a href="listing-left-column.html" target="_blank" class="btn btn-xl"
                                                 data-text="SHOP NOW!">SHOP NOW!</a></div>
            </div>
        </li>
        <li data-thumb="{{ asset('user_side/images/slides/01/slide-02.jpg') }}" data-transition="fade"
            data-slotamount="1" data-masterspeed="1000" data-saveperformance="off" data-title="Slide">
            <img src="{{ asset('user_side/images/slides/01/slide-02.jpg') }}" alt="slide1"
                 data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
            <div class="tp-caption tp-caption1 lft stb"
                 data-x="center"
                 data-y="center"
        ...
        <li data-thumb="{{ asset('user_side/video/video_img.jpg') }}" data-transition="fade" data-slotamount="1"
            data-masterspeed="1000" data-saveperformance="off" data-title="Slide">
            <img src="{{ asset('user_side/video/blank.png') }}" alt="slide1" data-bgposition="center center"
            ...
            <div class="tp-caption lfb lft text-center"
                ...
                <div class="tp-caption1-wd-3 tt-white-color">Oberlo allows you to easily import dropshipped products
                    directly into your ecommerce store
                </div>
                <div class="tp-caption1-wd-4"><a href="listing-left-column.html" target="_blank" class="btn btn-xl"
                                                 data-text="SHOP NOW!">SHOP NOW!</a></div>
            </div>
